import { defaultMapperFactory, createParsedCommandLineByJson, createVueLanguagePlugin, createLanguage, FileMap } from '@vue/language-core';
...
function createTwoslasher(createOptions = {}) {
  ...
  function getVueLanguage(compilerOptions, vueCompilerOptions) {
    ...
    function getLanguage() {
      ...
      const vueLanguagePlugin = createVueLanguagePlugin(ts, defaultCompilerOptions, vueOptions, (id) => id);
