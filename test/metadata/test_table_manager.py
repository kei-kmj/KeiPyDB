...
def test_multiple_tables_creation(real_metadata_env):
    ...
    tables_info = [
        ...
        ("products", [("product_id", FieldType.Integer, 0), ("title", FieldType.Varchar, 100), ("price", FieldType.Integer, 0)]),
        ("orders", [("order_id", FieldType.Integer, 0), ("user_id", FieldType.Integer, 0), ("product_id", FieldType.Integer, 0)])
    ]
